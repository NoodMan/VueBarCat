<template>
  <div>
    <form class="result">
      ...
      <select name="bookingSelect" id="bookingSelect" @change="showBooking" v-model="booking_id">
        <!-- <option value="">👀</option> -->
        <option v-for="booking in table_books" :key="booking.id" :value="booking.id">
          {{ booking.id}}
    ...
    <div class="result">
      <div>
        <strong>
          <label for="">Date de res : <br></label></strong>
        <span class="">
      ...
      <div>
        <strong>
          <label for="">n° de res : <br></label></strong>
        <span class="">
          {{ booking_selected?.id}}
        </span>
      </div>
      <div>
        <strong><label for="">nbr de personnege pour la resa : <br>
          </label></strong>
        <span class="">
      ...
      <div>
        <strong>
          <label for="">n° de la table reserver : <br></label></strong>
        <span class="">
      ...
      <div>
        <strong>
          <label for="">Prénom :</label></strong>
        <span class="">
          <br>{{ booking_selected?.user?.firstname }}
        </span>
      </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      showBooking() {
        this.booking_selected = this.table_books.find((b) => b.id == this.booking_id)
      }
    },
