<template>
    <div>
        <form class="result">
            ...
            <select name="free_tableSelect" id="free_tableSelect" @change="showTableFree" v-model="free_tables_id">
                <!-- <option value="">👀</option> -->
                <option v-for="free_table in free_tables" :key="free_table.id" :value="free_table.id">
                    {{ free_tableSelect.id}}
        ...
        <div class="result">
            ...
            <div>
                <strong>
                    <label for="">n° id : <br></label></strong>
                <span class="">
                    {{ free_tableSelect?.id}}
                </span>
            </div>
    ...
    export default {
        ...
        methods: {
            async getTable_free() {
                ...
                showTableFree() {
                    this.freeTable_selected = this.free_tables.find((b) => b.id == this.free_tables_id)
                }
            },
